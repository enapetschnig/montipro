-- Änderungswünsche: Melden aus der laufenden App heraus.
--
-- Ein Klick auf „Änderung melden" macht ein Bildschirmfoto und öffnet den
-- Dialog: tippen oder Sprachnachricht aufnehmen, Art wählen, im Bild
-- markieren. Bilder und Tonaufnahmen liegen im privaten Bucket
-- `aenderungswuensche`, Ordnername ist immer die eigene Benutzer-ID.
